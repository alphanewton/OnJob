...
import { getJobInfos } from "../../features/jobInfo/db";
import {
  Card,
  CardContent,
  CardFooter,
  ...
  return (
    <div className="container my-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 has-hover:*:not-hover:opacity-70">
        ...
        <Link className="transition-opacity" href="/home/jobinfo/new">
