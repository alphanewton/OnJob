...
import { createJobInfo, updateJobInfo } from "@/features/jobInfo/db";
import { toast } from "sonner";
import z from "zod";
import { experienceLevels, jobInfoSchema } from "@/types/general_schema";
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  Optional. Enter if there is a specific job title you are
                  applying for.
                </FormDescription>
                <FormMessage />
              </FormItem>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea
                  placeholder="A full stack web developer job that uses SQL for database management."
                  {...field}
                />
              </FormControl>
              <FormDescription>
